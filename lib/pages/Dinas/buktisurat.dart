...
class bukti_surat extends StatefulWidget {
  const bukti_surat({super.key});

  @override
  State<bukti_surat> createState() => _bukti_suratState();
}

class _bukti_suratState extends State<bukti_surat> {
  @override
